 ...
 * 年月日时分秒（yyyyMMddHHMISS、yyyy-MM-dd HH:MI:SS）等各种格式
 *
 ...
 *       15. 将日期的符串(Tue Mar 26 10:26:08 CST 2019 )转换为Date
 * @Description:
 * @Since: jdk1.8
 * @Author: gyk
 * @Date: 2020-04-03 19:04:03
 */
public class DateUtil{
    ...
    /**
     * 形如 Sat Jun 08 21:59:07 CST 2019 的格式
     * 是Date对象的默认格式
     */
    ...
    /**
     * 将Date对象类型的默认字符串(Tue Mar 26 10:26:08 CST 2019)转换为Date对象
     *
     * 注： new Date(String str)被启用了，而且会使用12小时为一天的表示法，即16时转换为4时
     * @param dateString
     * @return
     * @throws ParseException
     */
    public static Date dateStrToDate(String dateString) throws ParseException {
        return new SimpleDateFormat(DATE_DEFAULT_PATTERN, Locale.US).parse(dateString);
    }
